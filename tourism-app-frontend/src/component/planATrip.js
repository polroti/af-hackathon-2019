...
export default class PlanATrip extends Component{
    render(){
        return(
            <div>
                    <h1 align="center">SELECT YOUR TRAVEL THEME</h1><br/>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                ...
                                <center> <Button variant="danger">Ancient Cities</Button></center>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                ...
                                content.{' '}<br/>
                                <center> <Button variant="danger">Religious Places</Button></center>
                            </Card.Text>
                        </Card.Body>
                        <Card.Footer>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                This card has supporting text below as a natural lead-in to additional
                                content.{' '}<br/>
                               <center> <Button variant="danger">Nature Life</Button></center>
                            </Card.Text>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                ...
                                show that equal height action.<br/>
                                <center> <Button variant="danger">Party Places</Button></center>
