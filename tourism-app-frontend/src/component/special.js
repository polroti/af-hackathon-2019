...
export default class Special extends Component {
  render() {
    return (
      <div>
        <h2 align="center">Let's WelCome April</h2>
        <br />
        <p align="center">
          {" "}
          In april visit sri lanka to embrace the cultures of Sinhala & Tamil
          New Year and Vesak!
        </p>
        <br />
        <CardDeck>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                This new year, Anuradhapura, the historical city of Sri Lanka
                welcomes the new year with a great celebration
              </Card.Text>
            </Card.Body>
            <Card.Footer>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                The eastern part of the island celebrates the Sinhala and Tamil
                New Year with a great bang! Variety of activities including the
                Awurudu Sports and Customs are presented in an event organized
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Ther (Lord's Vehicle) is carried around the town and presented
                among the people for worship and blessings and for the
                betterment of the working class in the hill-country!
              </Card.Text>
            </Card.Body>
            <Card.Footer>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>Galle celebrates awurudu!</Card.Text>
            </Card.Body>
            <Card.Footer>
        ...
        <CardDeck>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Visit World's End in Horton Plains to experience the
                breathtaking views of the mist and clouds
              </Card.Text>
            </Card.Body>
            <Card.Footer>
              <small className="text-muted">Last updated 3 mins ago</small>
